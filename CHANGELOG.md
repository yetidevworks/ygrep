...
- **`indexer.docstore_compression_level`** — tune the doc store zstd level (1-22, or 0 for LZ4). Higher levels build a smaller index more slowly; search speed is unaffected. On a 3.0k-file project: level 0 gives a 15.9 MB index, level 3 (default) 13.3 MB, level 9 12.6 MB at no measurable extra build time, level 19 12.7 MB but four times slower to build
